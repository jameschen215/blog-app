...
<div
	class={cn(
		'flex items-center justify-center rounded-full border border-border text-lg font-semibold dark:border-zinc-900',
		className
	)}
>
	<span>
...
# src/lib/components/HeaderShell.svelte
...
<script lang="ts">
	...
	let { maxWidth = 'max-w-2xl', el = $bindable(), children }: Props = $props();
</script>
...
>
	<div class="relative mx-auto flex h-14 w-full {maxWidth} items-center justify-between px-6">
		{@render children()}
	</div>
</header>
...
# src/routes/(dashboard)/dashboard/posts/_components/TiptapEditor.svelte
...
# src/routes/(public)/posts/[id]/CommentEditor.svelte
...
# src/routes/auth/_components/AuthFormField.svelte
